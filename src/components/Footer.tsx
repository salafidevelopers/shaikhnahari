        ...
        <div className='bg-primary-800 p-5 pb-0 my-10 rounded-md'>
            ...
            <div className='flex space-x-0'>
                ...
                <div className='flex items-center z-40 space-x-2 w-full'>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#844e10" className="w-3 h-3 md:w-6 md:h-6">
                  ...
                  <input className='outline-none text-primary-800 text-xs p-2 md:p-3 w-full' placeholder='ادخل بريدك الألكتروني' />
                </div>
