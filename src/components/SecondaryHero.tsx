    ...
    <div className="space-y-4 bg-[url('/assets/hero_bg.jpg')] bg-cover bg-center bg-no-repeat px-10 pb-10 pt-16 text-primary-700">
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <span className="text-center text-xs">
          جديد أخبار الشيخ :جديد أخبار الشيخ جديد أخبار الشيخ جديد أخبار الشيخ
          جديد أخبار الشيخ جديد أخبار الشيخ جديد
          <br /> أخبار الشيخ جديد أخبار الشيخ جديد أخبار الشيخ
        </span>
      </div>
