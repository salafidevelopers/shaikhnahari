  ...
  return (
    <>
      ...
      <div className="my-6 px-14 md:px-10">
        <section className="my-5 flex  justify-between gap-5 rounded-md bg-white 2md:block">
          <div className=" w-1/2 flex-grow rounded-md border border-primary-200 p-3 shadow-md 2md:w-full">
          ...
          <div className=" w-1/2 flex-grow rounded-md bg-primary-100 p-3 2md:w-full">
        ...
        <section className="flex gap-4 2md:flex-col-reverse ">
          <div className="w-1/3 rounded-md bg-[url('/assets/important_contentBg.jpg')] bg-cover bg-top bg-no-repeat 2md:w-full">
          ...
          <div className="w-2/3  space-y-3 rounded-md border border-primary-200 bg-white p-3 shadow-md 2md:w-full">
            {audios.map((audio) => (
              <AudioCard
                key={audio.id}
                size={"lg"}
